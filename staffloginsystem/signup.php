...
?>
<form  class ="col-md-4 col-md-offset-4" action="includes/sign.php" method="post">
...
<img src="signup.png" alt="no image" class="center-block img-responsive"/ ><hr>
  ...
  <i class="form-control-feedback glyphicon glyphicon-lock"></i>
    ...
    <input type="email" class="form-control" id="exampleInputEmail" name="user_email" placeholder="email" required/>
